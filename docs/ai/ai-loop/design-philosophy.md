...
| touches-HO / C-4 merge（常時同期ブロック）               | **HITL**（現行 policy。touches-HO は恒久固定。C-4 merge の解禁判定は concept.md Phase 5 の HIC 決定として Human に留保 — 入口基準は [#733](https://github.com/s977043/plangate/issues/733)） |
