...
>
> **v7 ハイブリッドアーキテクチャ**: 本書の統制層を維持しつつ、実行層を Workflow / Skill / Agent 3 層で再構築したのが v7。詳細は [docs/plangate-v7-hybrid.md](./plangate-v7-hybrid.md) 参照。
...
各 Mode の詳細な GatePolicy は [`plugin/plangate/skills/skill-policy-router/SKILL.md`](../plugin/plangate/skills/skill-policy-router/SKILL.md) を参照してください。
