...
> Plan 作成時の設計判断は [`.agents/skills/ai-dev-plan/SKILL.md`](../../../.agents/skills/ai-dev-plan/SKILL.md) の「Plan Design Principles」節を実行規範とする。詳細正本は上流 `docs/ai/plan-design-principles.md`。原則全文を本 artifact へ転記せず、**今回 material な判断結果だけ**を残す。
