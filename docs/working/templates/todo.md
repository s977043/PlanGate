...
> 正本: [`.claude/rules/working-context.md`](../../../.claude/rules/working-context.md) の「todo.md（EXECUTION TODO）」節 /
> [`.agents/skills/ai-dev-plan/SKILL.md`](../../../.agents/skills/ai-dev-plan/SKILL.md) の「todo.md 規約」。
