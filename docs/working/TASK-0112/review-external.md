...
| R-003 (codex) | 設計/可読性 | major | AC-2 と TC-02 を check-plan-hash.sh の override パターンへ完全一致 (実体は 9 パターン、.claude/skills/ scripts/_*.py は対象外) | _次 PR で plan 反映_ |
