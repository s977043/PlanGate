...
> **訂正追記（2026-07-19・簡易 C-1 N-1）**: 上記集計は R-009 を deferred-to-C3 と
> 一部 reflected に二重計上していた。監査表 12 行の正しい status 別集計は:
> **reflected=8**（R-001/003/004/005/006/007/008/010。うち R-007 は C-3 併記条件付き）
> / **一部 reflected=1**（R-009）/ **deferred-to-C3=1**（R-002）/ **recorded=2**
> （R-011/R-012）= 計 12。既存行は追記専用規約により書き換えず、本追記を正とする。
