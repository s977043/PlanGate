...
- [`docs/working/TASK-0822/design-hotl-metrics.md`](../../working/TASK-0822/design-hotl-metrics.md) — reversal_rate との概念区別（未確認: 転記時点でリポジトリ未コミット。EPIC #822 の別項目ドラフトとして存在するが本 PBI のスコープ外）
