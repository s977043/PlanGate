...
**producer は [`scripts/ai-loop/corpus_hash.py`](../../../scripts/ai-loop/corpus_hash.py) を単一実装とする**
...
[`HarnessManifest`](../../ai/ai-loop-v2/harness-manifest.md) の `components[].registered`
