...
1. **PlanGate 本番フロー（WF-00〜07）の C-3 は常に Human・pre-exec のまま不変**。
   [`docs/ai/core-contract.md`](../../ai/core-contract.md) §3
...
- [`.claude/rules/working-context.md`](../../../.claude/rules/working-context.md) — C-3 Autonomous APPROVE（#353）・C-3 条件付き降格（F5-AD）の正本（PlanGate 本番フロー側 — §3.5 の役割分界参照）
