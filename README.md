...
| 項目             | 状態                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 最新リリース     | **v8.20.0**（Latest, 2026-08-14）— 配布経路の false green 是正（Codex plugin の `registered` 判定 / skill frontmatter 破損の 4 root 同時是正）+ Codex 用 plugin マニフェスト新設と parity 機械検出 + Codex CLI parity の実測化（強制力 0/11）。**EH-3 の HO 迂回（#1089）は未解消のまま出荷** — [CHANGELOG](CHANGELOG.md) の「⚠️ 既知の未解消ギャップ」を参照 / **v8.19.0**（2026-08-13）— 承認トークンガード EH-13 の fail-closed 化（**`jq` が実質必須。[CHANGELOG の「更新前に必ずお読みください」](CHANGELOG.md)を参照**）+ protected branch 破壊的 git 操作ガード EH-12 + テスト「静かに通る失敗」の封鎖 + plugin skill 参照解決の是正                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
