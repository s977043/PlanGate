...
| Item             | Status                                                                                                                                                                                                                               |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Latest release   | **v8.15.0** (Latest, 2026-06-23) — Review Gate mechanization + EH-3 doc-light + approve hardening + complete CLI test coverage + OpenSSF Scorecard support                                                                            |
