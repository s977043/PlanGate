...
run_pr_link_fixture "$PR_LINK_FIXTURES/pass-refs" "PASS" "pass-refs: non-closing link 'Refs: #N' accepted"
run_pr_link_fixture "$PR_LINK_FIXTURES/pass-part-of" "PASS" "pass-part-of: non-closing link 'Part of #N' accepted"
run_pr_link_fixture "$PR_LINK_FIXTURES/warn-bare-hash" "WARN" "warn-bare-hash: bare #N without keyword stays WARN"
