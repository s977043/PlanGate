...
V-1/handoff 完了の DoD（`05_verify_and_handoff.md`
...
> 追跡は `status.md` の BLOCKED 項目。
> 本節の実測根拠: `hooks-list-reverify.md`
...
> `1104-bash-lane-noop-patch-applicable.md`。
...
> 採番していたが、`hook-enforcement.md` 側で **EH-10 / EH-11 は
