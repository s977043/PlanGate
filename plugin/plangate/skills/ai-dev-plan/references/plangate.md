...
> 項目定義の正本は [`docs/working/templates/review-self.md`](./review-self.md)。
...
> `settings-wiring-contract.md` §Codex CLI parity を参照。
...
詳細: `settings-wiring-contract.md` §Codex CLI parity。
